import {html, css, FlowFormat, i18n, T} from './slyvex-wallet-ui.js';
import {SlyvexWalletMobile} from './slyvex-wallet-mobile.js';

export class SlyvexWalletDesktop extends SlyvexWalletMobile{
	...
	static get styles(){
		return [SlyvexWalletMobile.styles, css`
			:host{overflow:hidden}
			.container{
				padding:var(--slyvex-wallet-container-padding, 15px);
			...
			.wallet-warning{
				...
				background-color:var(--slyvex-wallet-warning-bg, #fdf8e4);
			}
			...
			.right-area{
				...
				height:var(--slyvex-wallet-right-area-height, calc(100vh - 122px));
			...
			.top-menu{
				...
				position:var(--slyvex-wallet-top-menu-position, absolute);
				right:var(--slyvex-wallet-top-menu-right, 20px);
				top:var(--slyvex-wallet-top-menu-top, -4px);
				z-index:2;
			...
			.header{
				border-bottom:var(--slyvex-wallet-header-border-bottom, --2px solid var(--slyvex-wallet-tab-border-top-color, var(--flow-primary-color)));
			}
		`];
	}
	constructor() {
