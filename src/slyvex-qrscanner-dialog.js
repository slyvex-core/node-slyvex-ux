...
class SlyvexQRScannerDialog extends SlyvexDialog{
	...
	static get styles(){
		return [SlyvexDialog.styles, css`
			.container{
				...
				max-height:var(--slyvex-dialog-container-max-height, 620px);
			}
...
SlyvexQRScannerDialog.define("slyvex-qrscanner-dialog");
