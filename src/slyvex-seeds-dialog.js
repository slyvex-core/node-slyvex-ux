import {
	html, css, SlyvexDialog, chunks, getRandomInt, shuffle,
	T, i18n
} from './slyvex-dialog.js';

class SlyvexSeedsDialog extends SlyvexDialog{
	...
	static get styles(){
		return [SlyvexDialog.styles, css`
			...
			.container{max-height:var(--slyvex-dialog-container-max-height, 660px)}
...
SlyvexSeedsDialog.define("slyvex-seeds-dialog");
