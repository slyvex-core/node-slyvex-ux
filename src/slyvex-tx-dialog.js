import {
	html, css, SlyvexDialog, SVX, txListStyle,
	paginationStyle, buildPagination,
	renderPagination, T
} from './slyvex-dialog.js';

class SlyvexTXDialog extends SlyvexDialog{
	...
	static get styles(){
		return [SlyvexDialog.styles, paginationStyle, txListStyle,
		css`
			:host{
				position:fixed;
			...
			.container{
				max-height:var(--slyvex-dialog-container-max-height, 90%);
				max-width:var(--slyvex-dialog-container-max-width, 90%)
			}
...
SlyvexTXDialog.define("slyvex-tx-dialog");
